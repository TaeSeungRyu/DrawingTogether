...
`doc/bug-hunt-2026-07-01.md`의 확정 17건을 수정할 때 사용하는 검증 가이드.
...
**확정 17건 코드 전부 완료** + 신규 Duo 하트비트 1건. 각 항목 별도 커밋. 남은 것은 멀티 기기 QA뿐.

| 항목 | 커밋 | 코드 | 검증 상태 |
|---|---|---|---|
| #1 선 굵기 정규화 | `6b9d8ec` | ✅ | 유닛 + 기기 1대 QA ✅ |
| #16 타임랩스 굵기 | `2e428d1` | ✅ | 유닛 + 기기 1대 QA ✅ |
| #8 applySnapshot undo 순서 | `1110ed8` | ✅ | 유닛 ✅ (기기 선택) |
| #6 openStroke 누수 | `a92dc5e` | ✅ | 유닛 + 기기 QA ✅ |
| #7 Duo 재연결 교착 | `f8f5b18` | ✅ | 기기 2대 QA ✅ |
| Duo 하트비트 (신규) | `6ddd7a8` | ✅ | 기기 2대 QA ✅ |
| #2 maxJoiners 우회 | `212a30a` | ✅ | ⏳ 3대+ QA 남음 |
| #3 동시 pending 유실 | `212a30a` | ✅ | ⏳ 3대+ QA 남음 |
| #11 인코더 누수 | `1b08410` | ✅ | ⏳ 코드리뷰/스트레스 |
| #10 공유 컬렉션 | `d2655ae` | ✅ | ⏳ 코드리뷰/스트레스 |
| #14 orphan png | `bf4f8bb` | ✅ | 유닛 ✅ + 크래시 재현 QA |
| #15 동시 save 이름 | `bf4f8bb` | ✅ | ⏳ 코드리뷰 |
| #17 EdgeDetector recycle | `2d2f0f1` | ✅ | ⏳ 코드리뷰 |
| #12 스티커 핸들 no-op | `3449204` | ✅ | ⏳ 멀티 관측 QA 남음 |
| #13 조인자 재검색 | `3d801c8` | ✅ | ⏳ 3대+ QA 남음 |
| #4 배경색/비율 발신자 | `c996921` | ✅ | 코덱 유닛 ✅ + ⏳ 3대+ QA |
| #5 스냅샷 발신자 | `c996921` | ✅ | 코덱 유닛 ✅ + ⏳ 3대+ QA |
| #9 에어브러시 등 질감 | (#1 헬퍼) | ✅ | export 관점 #1로 해소(별도 수정 없음) |

> 아래 각 섹션의 상세 QA 스텝은 그대로 유효 — ⏳ 표시 항목의 기기 검증에 사용.
